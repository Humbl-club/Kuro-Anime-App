-- ============================================================
-- fetch_club_bundle patch: member identity + per-member status freshness
-- - Include profiles.display_name where visible by sharing policy
-- - Include member_statuses.updated_at for active/dormant UI logic
-- - Include episode_count/chapter_count on rail items for progress fractions
-- ============================================================
