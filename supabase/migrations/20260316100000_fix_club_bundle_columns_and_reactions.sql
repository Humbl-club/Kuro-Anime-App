-- ============================================================
-- Fix fetch_club_bundle: restore correct column names + reactions
--
-- Bugs introduced in 20260313100000_slim_club_bundle_limits:
--   1. a.episode_count → should be a.episodes
--   2. m.chapter_count → should be m.chapters
--   3. reactions + my_reactions dropped from item JSON
-- ============================================================
