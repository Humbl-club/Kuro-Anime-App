-- Enrich search_titles() to return year + format from anime/manga catalog tables.
-- Backwards-compatible: same function name/args, two new nullable columns appended.
