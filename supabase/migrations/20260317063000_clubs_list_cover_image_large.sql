-- ============================================================
-- Switch cover_images in fetch_my_clubs_enriched() from
-- cover_image_medium to cover_image_large (with medium fallback)
-- to avoid blurry images on full-width club cards.
-- ============================================================
