-- Replace toggle_club_reaction with version that adds:
-- 1. Rate limit: 30 reactions per 60 seconds
-- 2. Emoji allowlist: only the 4 approved emojis
...
BEGIN
  ...
  -- Find the club for this rail item
